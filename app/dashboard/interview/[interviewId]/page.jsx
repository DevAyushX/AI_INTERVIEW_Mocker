...
function Interview({ params }) {
    ...
    const [webCamEnabled, setWebCamEnabled] = useState(false); // Explicitly set to false
    ...
    const GetInterviewDetails = async () => {
        ...
        setInterviewData(result[0] || null); // Ensure it's null if not found
    }
                ...
                <div className='flex flex-col my-5 gap-5'>
                    <div className='flex flex-col p-5 rounded-lg border gap-5'>
                        <h2 className='text-lg'>
                            <strong>Job Role/Job Position:</strong> {interviewData?.jobPosition || "N/A"}
                        </h2>
                        <h2 className='text-lg'>
                            <strong>Job Description/Tech Stack:</strong> {interviewData?.jobDesc || "N/A"}
                        </h2>
                        <h2 className='text-lg'>
